...
The module is a Symfony-based PHP project. Source assets live in `assets/`, compiled runtime assets live in `public/assets/`, and templates live in `templates/`.
...
```bash
./tools/dev2prod.sh json-viewer-module
```
